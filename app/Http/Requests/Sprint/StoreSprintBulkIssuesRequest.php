...
class StoreSprintBulkIssuesRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        if (!$checkProjects && $checkIfUserTeamMember) return true;
        return false;
    }
    ...
    public function rules(): array
    {
        $projectId = $this->input('project_id');
        return [
            'issues_id' => ['required', 'array'],
            'issues_id.*' => ['required', Rule::exists('issues', 'id')
